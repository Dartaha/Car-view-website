...
<body>
  ...
  <header class="site-header">
    <div class="container header-inner">
      ...
      <a class="cta-button" href="#contact">Get a Quote</a>
    </div>
  </header>
        ...
        <aside class="hero-visual" aria-label="Featured highlights">
          <div class="hero-vehicle">
            <div class="hero-vehicle-top">
              ...
              <span class="hero-model">SuperClean Sedan</span>
            </div>
      ...
      <div class="container">
        ...
        ?>
          <article class="vehicle-card">
            <div class="vehicle-image" aria-hidden="true"><img src="<?php echo $c_detail[4]; ?>" alt=""></div>
          ...
          <!-- <article class="vehicle-card">
            <div class="vehicle-image image-2" aria-hidden="true"></div>
            <div class="vehicle-content">
              <div class="vehicle-top">
                <h3>Honda Civic 2022</h3>
                <span class="price">$15,500</span>
              </div>
              <p class="vehicle-meta">Automatic • 33,000 km</p>
              <ul class="vehicle-features">
                <li>Apple CarPlay</li>
                <li>Lane Assist</li>
                <li>Alloy Wheels</li>
          ...
          <article class="vehicle-card">
            <div class="vehicle-image image-3" aria-hidden="true"></div>
            <div class="vehicle-content">
              <div class="vehicle-top">
                <h3>Hyundai Tucson 2020</h3>
                <span class="price">$14,200</span>
              </div>
              <p class="vehicle-meta">Automatic • 52,000 km</p>
              <ul class="vehicle-features">
                <li>Sunroof</li>
          ...
          <article class="vehicle-card">
            <div class="vehicle-image image-4" aria-hidden="true"></div>
            <div class="vehicle-content">
              <div class="vehicle-top">
                <h3>Nissan Qashqai 2019</h3>
                <span class="price">$11,750</span>
              </div>
              <p class="vehicle-meta">CVT • 61,000 km</p>
              <ul class="vehicle-features">
                <li>Power Mirrors</li>
                <li>Bluetooth</li>
                <li>Roof Rails</li>
          ...
          <article class="vehicle-card">
            <div class="vehicle-image image-5" aria-hidden="true"></div>
            <div class="vehicle-content">
              <div class="vehicle-top">
                <h3>Ford Escape 2021</h3>
                <span class="price">$16,400</span>
              </div>
              <p class="vehicle-meta">Automatic • 40,000 km</p>
              <ul class="vehicle-features">
                <li>Blind Spot</li>
                <li>Touchscreen</li>
                <li>USB Ports</li>
          ...
          <article class="vehicle-card">
            <div class="vehicle-image image-6" aria-hidden="true"></div>
            <div class="vehicle-content">
              <div class="vehicle-top">
                <h3>Volkswagen Jetta 2020</h3>
                <span class="price">$13,600</span>
              </div>
              <p class="vehicle-meta">Automatic • 49,500 km</p>
              <ul class="vehicle-features">
